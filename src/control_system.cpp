...
ControlSystem::ControlSystem()
    : direction_button_(kDirectionButtonPin, MomentaryButton::PinState::kLow, 300, 500, 1000),
      speed_button_(kSpeedButtonPin, MomentaryButton::PinState::kLow, 300, 500, 1000),
      angle_button_(kAngleButtonPin, MomentaryButton::PinState::kLow, 300, 500, 1000) {
}
